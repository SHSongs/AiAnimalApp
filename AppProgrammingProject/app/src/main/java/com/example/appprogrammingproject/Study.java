    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final String[] item = new String[]{"\uD83D\uDEB6\u200D♂️ 계속 걷는다", "\uD83D\uDE83 마차",
                        "\uD83D\uDE96 택시", "\uD83D\uDC68\u200D❤️\u200D\uD83D\uDC68 친구와 걷는다"};
                ...
                a.setTitle("\uD83D\uDEE3️ 길을 걷고 있는 당신, 뭔가를 탈 수 있다면 선택할 수단을 골라주세요").setSingleChoiceItems(item, -1, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (i == 0) {
                            ...
                            result.setTitle("\uD83D\uDC68\u200D❤️\u200D\uD83D\uDC68 외롭지 않게 친구와 걸어야지!");
        ...
        two.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String[] item = new String[]{"\uD83D\uDD32 정사각형", "⬜ 직사각형", "\uD83D\uDD3A 삼각형", "⭕ 동그라미", "\uD83C\uDF2B️ 구불구불한 선"};
        ...
        three.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String[] item = new String[]{"\uD83D\uDE32 동상을 마주본다", "\uD83D\uDC81\u200D♀️ 동상에 몸을 기댄다", "\uD83E\uDD38 동상은 필요없고 나만의 포즈를 취한다", "\uD83D\uDC68\u200D\uD83D\uDC66 어깨동무를 한다"};
                ...
                a.setTitle("\uD83D\uDDFD 당신은 멋진 동상을 발견했습니다! 어떤 자세로 사진을 찍을 건가요?").setSingleChoiceItems(item, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (i == 0) {
                            ...
                            result.setTitle("\uD83D\uDC81\u200D♀️ 동상에 기대는 편안한 포즈를 취한다");
