    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (i == 0) {
                            ...
                            result.setMessage("로맨틱한 사랑을 꿈꾸는 낭만적인 성격이면서도 매우 꼼꼼한 면이 있는 타입이에요." +
                                    "특히 현실과 이상에 대한 계획을 구체적으로 세우면서 연예를 하는 편이랍니다!");
        ...
        two.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String[] item = new String[]{"신나게 탬버린을 들고 춤춘다", "앞에 나서서 노래를 부른다", "열심히 노래의 번호를 검색한다", "열심히 박수를 쳐준다"};
                ...
                a.setTitle("별로 친하지 않은 친구와 노래방을 갔다. 그런 자리에서 당신의 행동은?").setSingleChoiceItems(item, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (i == 0) {
                            ...
                            result.setTitle("앞에 나서서 노래를 부른다");
                ...
                a.setTitle("눈 앞에 잡고싶은 물건이 여러개 있다. 제일 먼저 무엇을 잡을까?").setSingleChoiceItems(item, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (i == 0) {
                            ...
                            result.setTitle("과일");
                            result.setMessage("생각이 많고 진지해보이는 연상");
                            ...
                            result.setTitle("떡");
                            result.setMessage("말을 잘하고 매너가 좋은 사람");
                            ...
                            result.setTitle("구슬");
                            result.setMessage("열정적이고 사랑을 퍼주는 사람");
                            ...
                            result.setTitle("돈");
                            result.setMessage("부드러운 인상과 따뜻한 내면을 가진 사람");
                            ...
                            result.setTitle("반지");
                            result.setMessage("자신을 보호해줄 수 있는 연하");
